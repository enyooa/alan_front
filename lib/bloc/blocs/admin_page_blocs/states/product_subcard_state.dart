...
// product_subcard_state.dart

class SingleProductSubCardLoaded extends ProductSubCardState {
  final Map<String, dynamic> subCard;
  SingleProductSubCardLoaded(this.subCard);
}
